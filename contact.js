...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (clientBtn && talentBtn) {
        clientBtn.addEventListener('click', () => {
            typeInput.value = "Hire Talent";
            clientBtn.classList.add('active');
            talentBtn.classList.remove('active');
            if (messageLabel) messageLabel.innerText = "Mandate Brief";
        });
        ...
        talentBtn.addEventListener('click', () => {
            ...
            if (messageLabel) messageLabel.innerText = "Career Objectives";
        });
    }
    ...
    if (form) {
        form.addEventListener('submit', function(event) {
            ...
            const serviceID = 'service_p825cqa';
